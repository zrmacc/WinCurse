...
## Model
See the model specification [here](https://github.com/zrmacc/WinCurse/blob/master/inst/extdata/Model.pdf). After installing the package, the PDF is also available as `system.file("extdata", "Model.pdf", package = "WinCurse")`. The parameters estimated by this package are the probability of membership to the null component (pi) and the variance component (tau^2) of the non-null component. 
